...
const CoinRankItem: React.FC<Props> = ({ stock, index, onClick }) => {
  return (
    <div
      ...
      className="border-slate-200 dark:border-slate-700 flex items-center justify-between p-3 bg-gray-700/50 rounded-xl hover:bg-gray-700 transition-all cursor-pointer"
    >
